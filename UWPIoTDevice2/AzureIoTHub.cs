...
class AzureIoTHub
{
    ...
    //
    // Note: this connection string is specific to the device "rangojoIoTDevice1". To configure other devices,
    // see information on iothub-explorer at http://aka.ms/iothubgetstartedVSCS
    //
    const string deviceConnectionString = "HostName=rangoIoThub1.azure-devices.net;DeviceId=rangojoIoTDevice1;SharedAccessKey=k8ToL7irZHeFU3wFBXxfMceEZfWdnhZrD8bYCJDbdxA=";


    //
    // To monitor messages sent to device "kraaa" use iothub-explorer as follows:
    //    iothub-explorer monitor-events --login HostName=rangoIoThub1.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=bJubgN0SKIUNJWBHmNZfvhSlhSd1DLcycAupjzxxj8A= "rangojoIoTDevice1"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync()
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"rangojoIoTDevice1\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"rangojoIoTDevice1\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
